...
ActiveRecord::Schema.define(version: 20160712094642) do
  ...
  create_table "time_tracks", force: :cascade do |t|
    ...
    t.integer  "number_of_hours", limit: 4
    t.string   "description",     limit: 255
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  ...
  add_index "time_tracks", ["project_id"], name: "index_time_tracks_on_project_id", using: :btree
  ...
  add_foreign_key "time_tracks", "projects"
